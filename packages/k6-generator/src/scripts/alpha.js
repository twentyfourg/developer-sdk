...
export default function (_) {
  let vuObj = {"email":"rose.landroche@24g.com","password":"insecure123!@#","firstName":"Rose","lastName":"Landroche","id":"1287b0b6-af73-43cf-806c-6119c4a6bf7b","calendarSyncToken":"83e1ecfe-c358-4e18-a55f-67bb13cb9397","challengeId":"","classroomId":"","pollId":"","itemId":""};
...
;
  ...
  payload = ["email","password"]
        ...
        tagName = 'userLoginRes';
            ...
            check(
          userLoginRes, {
            ['login - /users/auth returns successful status']:  (r) => r.status === 200 || r.status === 204,
            ['login - /users/auth returns valid body']: (r) =>
            r.status === 204 ? true : r.json().hasOwnProperty('token'),
            ['login - /users/auth returns no error codes']: (r) => r.error_code === 0,
          },
          { tag: 'userLogin' }
          );
          reqBody = {}
          sleep(SLEEP_DURATION);
            ...
            const userProfileRes = http.get(`https://api-dev-2772-1.demo.lxp.live/users/${vuObj['id']}/profile`, {
            ...
            userProfileRes,
            {
              ...
              r.status !== 204 && true ? r.json().hasOwnProperty('user') : JSON.stringify(r.body).includes('null'),
            ...
            const userConnectionsRes = http.get(`https://api-dev-2772-1.demo.lxp.live/users/${vuObj['id']}/connections`, {
            ...
            userConnectionsRes,
            {
              ...
              r.status !== 204 && true ? r.json().hasOwnProperty('userConnections') : JSON.stringify(r.body).includes('null'),
            ...
            const userBadgesRes = http.get(`https://api-dev-2772-1.demo.lxp.live/users/${vuObj['id']}/badges`, {
            ...
            userBadgesRes,
            {
              ...
              r.status !== 204 && true ? r.json().hasOwnProperty('userBadges') : JSON.stringify(r.body).includes('null'),
            ...
            userClassroomsRes,
            {
              ...
              r.status !== 204 && true ? r.json().hasOwnProperty('classrooms') : JSON.stringify(r.body).includes('null'),
            ...
            const userClassroomsLinkRes = http.get(`https://api-dev-2772-1.demo.lxp.live/users/classrooms/link`, {
            ...
            userClassroomsLinkRes,
            {
              ...
              r.status !== 204 && true ? r.json().hasOwnProperty('icsLink') : JSON.stringify(r.body).includes('null'),
            ...
            userNotepadsRes,
            {
              ...
              r.status !== 204 && true ? r.json().hasOwnProperty('notepads') : JSON.stringify(r.body).includes('null'),
            ...
            challengesAllRes,
            {
              ...
              r.status !== 204 && true ? r.json().hasOwnProperty('challenges') : JSON.stringify(r.body).includes('null'),
            ...
            const challengeOneRes = http.get(`https://api-dev-2772-1.demo.lxp.live/challenges/${vuObj["challengeId"]}`, {
            ...
            challengeOneRes,
            {
              ...
              r.status !== 204 && true ? r.json().hasOwnProperty('id') : JSON.stringify(r.body).includes('null'),
            ...
            classroomsAllRes,
            {
              ['get - /classrooms returns successful status']: (r) =>
              r.status === 200 || r.status === 204,
            ...
            classLiveNowRes,
            {
              ...
              r.status !== 204 && true ? r.json().hasOwnProperty('live') : JSON.stringify(r.body).includes('null'),
            ...
            const classSubscribeRes = http.get(`https://api-dev-2772-1.demo.lxp.live/classrooms/subscribe?token=${vuObj['calendarSyncToken']}`, {
            ...
            classSubscribeRes,
            {
              ...
              r.status !== 204 && false ? r.json().hasOwnProperty('null') : JSON.stringify(r.body).includes('BEGIN:VCALENDAR'),
              ['get - /classrooms/subscribe?token=${calendarSyncToken} returns no error codes']: (r) => r.error_code === 0,
            },
            { tag: 'classSubscribe' }
            );
            reqBody = {}
            ...
            const classroomOneRes = http.get(`https://api-dev-2772-1.demo.lxp.live/classrooms/${vuObj["classroomId"]}`, {
            ...
            classroomOneRes,
            {
              ...
              r.status !== 204 && true ? r.json().hasOwnProperty('classroom') : JSON.stringify(r.body).includes('null'),
            ...
            const classroomNotepadRes = http.get(`https://api-dev-2772-1.demo.lxp.live/classrooms/${vuObj["classroomId"]}/notepad`, {
            ...
            classroomNotepadRes,
            {
              ...
              r.status !== 204 && true ? r.json().hasOwnProperty('notepad') : JSON.stringify(r.body).includes('null'),
              ['get - /classrooms/${classroomId}/notepad returns no error codes']: (r) => r.error_code === 0,
            },
            ...
            userPointsRes,
            {
              ...
              r.status !== 204 && true ? r.json().hasOwnProperty('rewardPoints') : JSON.stringify(r.body).includes('null'),
            ...
            pollsAllRes,
            {
              ['get - /polls returns successful status']: (r) =>
              r.status === 200 || r.status === 204,
              ['get - /polls returns valid body']: (r) =>
              r.status !== 204 && true ? r.json().hasOwnProperty('polls') : JSON.stringify(r.body).includes('null'),
            ...
            pollOneRes,
            {
              ...
              r.status !== 204 && true ? r.json().hasOwnProperty('poll') : JSON.stringify(r.body).includes('null'),
            ...
            storeAllItemsRes,
            {
              ['get - /store returns successful status']: (r) =>
              r.status === 200 || r.status === 204,
              ['get - /store returns valid body']: (r) =>
              r.status !== 204 && true ? r.json().hasOwnProperty('items') : JSON.stringify(r.body).includes('null'),
            ...
            const storeOneItemRes = http.get(`https://api-dev-2772-1.demo.lxp.live/store/${vuObj["itemId"]}`, {
            ...
            storeOneItemRes,
            {
              ...
              r.status !== 204 && true ? r.json().hasOwnProperty('item') : JSON.stringify(r.body).includes('null'),
            ...
            enumsRes,
            {
              ['get - /enums returns successful status']: (r) =>
              r.status === 200 || r.status === 204,
              ['get - /enums returns valid body']: (r) =>
              r.status !== 204 && true ? r.json().hasOwnProperty('assetTypes') : JSON.stringify(r.body).includes('null'),
            ...
            sliderRes,
            {
              ['get - /slider returns successful status']: (r) =>
              r.status === 200 || r.status === 204,
              ['get - /slider returns valid body']: (r) =>
              r.status !== 204 && true ? r.json().hasOwnProperty('slider') : JSON.stringify(r.body).includes('null'),
...
payload = null
        ...
        tagName = 'userLogoutRes';
            ...
            check(
          userLogoutRes, {
            ['logout - /users/logout returns successful status']:  (r) => r.status === 200 || r.status === 204,
            ['logout - /users/logout returns valid body']: (r) =>
            r.status === 204 ? true : r.json().hasOwnProperty(''),
            ['logout - /users/logout returns no error codes']: (r) => r.error_code === 0,
          },
          { tag: 'userLogout' }
          );
          reqBody = {}
